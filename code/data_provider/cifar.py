...
class TinyDataProvider(DataProvider):
    ...
    def read_tiny_test(self):
        ...
        data_X = np.load('../dataset/tiny/tiny-imagenet_val_image_matrix.npy').astype(float)
        data_Y = np.load('../dataset/tiny/true-tiny-imagenet_val_label_matrix.npy').astype(int)
